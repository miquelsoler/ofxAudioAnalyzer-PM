...
//    float getPitchConf(){return YinConfidence_f;}
    ...
    //float getPitchFreqMelodia(){return MelodiaFrequency_f;}
    //float getPitchConfMelodia(){return MelodiaConfidence_f;}
    ...
    doHpcp, doHfc, doCentroid, doSpcCmplx, doInharmon, doPitchMelodia;
    // TODO: Silence
